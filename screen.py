...
class ScreenBase:
    ...
    def match(self, template: str = "", screenshot: ScreenShot = None, match_threshold: float = None) -> list[Any]:
        ...
        template_w, template_h = self.template.shape[::-1]
    ...
    def matches(self, templates: list,screenshot: ScreenShot = None, match_threshold: float = None):
        threshold = match_threshold if match_threshold else self.match_threshold
...
class ScreenAdventureAbyss(ScreenBase):
    def __init__(self, screenshot: ScreenShot):
        super().__init__('templates/adventure_abyss.png', screenshot, 0.9)
